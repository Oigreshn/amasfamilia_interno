                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10 2a8 8 0 108 8 8 8 0 00-8-8zM9 9V5a1 1 0 112 0v4a1 1 0 01-1 1H5a1 1 0 110-2h4z"></path>
                        </svg>
                        <span>{{ __('Panel de Control') }}</span>
                    </x-nav-link>

                    <!-- User Management Dropdown -->
                    <x-dropdown class="inline-flex items-center">
                        <x-slot name="trigger">
                            <div class="inline-flex items-center cursor-pointer space-x-1 border-b-2 px-1 pt-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                </svg>
                                <span class="text-sm">{{ __('Gestor de Usuarios') }}</span> 
                            </div>
                        </x-slot>
                        <x-slot name="content">
                    ...
                    <x-dropdown class="inline-flex items-center">
                        <x-slot name="trigger">
                            <div class="inline-flex items-center cursor-pointer space-x-1 border-b-2 px-1 pt-1">
                                ...
                                <span class="text-sm">{{ __('Control de Tablas') }}</span> 
                            </div>
                        </x-slot>
                        <x-slot name="content">
                            <x-dropdown-link :href="route('paises.index')" :active="request()->routeIs('paises.index')">
                            ...
                            <x-dropdown-link :href="route('estadocivil.index')">
                            ...
                            <x-dropdown-link :href="route('estadolaboral.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            ...
                            <x-dropdown-link :href="route('permisoresidencia.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
                                </svg>
                                  {{ __('Permiso Residencia') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('permisotrabajo.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" />
                                </svg>                                  
                                {{ __('Permiso de Trabajo') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('redcercana.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <x-dropdown-link :href="route('tipotarjetas.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <x-dropdown-link :href="route('parentesco.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <!-- Administración de Miembros y Derivación -->
                    <x-dropdown class="inline-flex items-center">
                        <x-slot name="trigger">
                            <div class="inline-flex items-center cursor-pointer space-x-1 border-b-2 px-1 pt-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                ...
                                <span class="text-sm">{{ __('Gestor de Miembros') }}</span> 
                            </div>
                        </x-slot>
                            
                        <x-slot name="content">
                            <x-dropdown-link :href="route('miembrosprincipales.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            ...
                            <x-dropdown-link :href="route('miembrosecundario.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                ...
                                {{ __('Miembros Secundarios') }}
                            </x-dropdown-link>
    
                            <x-dropdown-link :href="route('derivaciones.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    <x-dropdown class="inline-flex items-center">
                        <x-slot name="trigger">
                            <div class="inline-flex items-center cursor-pointer space-x-1 border-b-2 px-1 pt-1">
                                ...
                                <span class="text-sm">{{ __('Agenda') }}</span> 
                            </div>
                        </x-slot>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('historial.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        ...
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="ml-1">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M5.292 7.707a1 1 0 011.415 0L10 10.999l3.293-3.292a1 1 0 011.414 1.415l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.415z" clip-rule="evenodd" />
                                </svg>
                            </div>
                        </button>
                    </x-slot>
